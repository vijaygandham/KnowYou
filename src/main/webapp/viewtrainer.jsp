...
<html lang="en" dir="ltr">
   ...
   <body>
      ...
      <form>
<table>
<h2 align="center">Trainer details</h2>
<tr><th>ID:</th>&nbsp;<td>${tra.id}</td></tr>
<tr><th>Name:</th>&nbsp;<td>${tra.name}</td></tr>
<tr><th>Gender:</th>&nbsp;<td>${tra.gender}</td></tr>
<tr><th>Qualification:</th>&nbsp;<td>${tra.qualification}</td></tr>
<tr><th>Experience:</th>&nbsp;<td>${tra.experience}</td></tr>
<tr><th>Organisation:</th>&nbsp;<td>${tra.organisation}</td></tr>
<tr><th>Location:</th>&nbsp;<td>${tra.location}</td></tr>
<tr><th>Email ID:</th>&nbsp;<td>${tra.emailid}</td></tr>
<tr><th>Contact No:</th>&nbsp;<td>${tra.contactno}</td></tr>
