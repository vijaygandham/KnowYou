        ...
        <main>
            ...
            <div class="records table-responsive">
                    ...
                    <div class="record-header">
                        <div class="add">
                            <button><a href="facultyreg" style="color: white">Add record</a></button>
                        </div>
                        ...
                        <table width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <th><span class="las la-sort"></span> Designation</th>
...
<td> <c:out value="${fac.faculty_id}"></c:out>   </td>
<td> <c:out value="${fac.name}"></c:out>   </td>
<td> <c:out value="${fac.gender}"></c:out>   </td>
<td> <c:out value="${fac.dob}"></c:out>   </td>
<td> <c:out value="${fac.department}"></c:out>   </td>
<td> <c:out value="${fac.qualification}"></c:out>   </td>
<td> <c:out value="${fac.designation}"></c:out>   </td>
<td> <c:out value="${fac.experience}"></c:out>   </td>
<td> <c:out value="${fac.emailid}"></c:out>   </td>
<td> <c:out value="${fac.username}"></c:out>   </td>
<td> <c:out value="${fac.contactno}"></c:out>   </td>
<td> 

<a style="color: red"; href='<c:url value='deletefac?id=${fac.id}'></c:url>'>Delete</a>&nbsp;&nbsp;
<a style="color: red"; href='<c:url value='viewfacbyid?id=${fac.id}'></c:url>'>View</a>&nbsp;&nbsp;
